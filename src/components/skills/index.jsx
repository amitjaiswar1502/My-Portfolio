    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-5xl sm:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">
                        Skills
                    </h2>
                    <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                        Passionate web developer creating innovative and
                        user-friendly applications. Firm believer in lifelong
                        learning as the foundation for growth and creativity.
                    </p>
                    <div className="mt-12">
                        <DownloadButton />
                    </div>
